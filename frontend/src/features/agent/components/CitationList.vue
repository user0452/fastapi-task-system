...
<style scoped>
.citation-list { display: grid; gap: 5px; margin-top: 10px; padding-top: 9px; border-top: 1px solid var(--border-subtle); }
...
.citation-row:hover { color: #175d4c; background: var(--accent-soft); }
...
.citation-row p { color: var(--text-secondary); font-size: 8px; }
</style>
