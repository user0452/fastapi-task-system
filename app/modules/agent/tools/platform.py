...
def build_default_tool_registry() -> ToolRegistry:
    ...
    definitions = [
        ...
        ToolDefinition("list_course_memories", "列出课程长期记忆", "memory", "read", 10),
        ToolDefinition("write_course_memory", "写入课程长期记忆", "memory", "write", 15),
        ToolDefinition("update_course_memory", "修改课程长期记忆", "memory", "write", 15),
        ToolDefinition(
